let url = 'https://raw.githubusercontent.com/no-stack-dub-sack/testable-projects-fcc/master/src/data/choropleth_map/counties.json';
...
let us_county_data;
let us_education_data;

d3.json(url, function(error, dataset) {
  us_county_data = dataset;
  
  d3.json(url1, function(error, dataset) {
    us_education_data = dataset;
